  ...
  return (
    <View style={styles.coachCard}>
      <View style={styles.coachIcon}>
        <Ionicons name="chatbubble-ellipses-outline" size={21} color={colors.primaryLight} />
      </View>
        ...
        <View style={styles.externalActions}>
          ...
          >
            <View style={styles.actionIcon}>
              <Ionicons name="barbell-outline" size={19} color={colors.primaryLight} />
            </View>
          ...
          >
            <View style={[styles.actionIcon, styles.actionIconRed]}>
              <Ionicons name="trophy-outline" size={19} color={colors.brandRed} />
            </View>
            <View style={styles.actionCopy}>
...
export default function DashboardDesignWorkbench() {
  ...
  const loadDashboard = useCallback(async () => {
    try {
      ...
      console.warn('Dashboard design workbench', loadError);
      setError(
  ...
  async function handlePrimaryAction() {
    ...
    try {
      ...
      console.warn('Dashboard design resume session', resumeError);
      router.push('/workout/preparation');
    } finally {
      setResuming(false);
    }
        ...
        >
          <View style={styles.heroShell}>
            ...
            >
              ...
              <View style={styles.heroTopRow}>
                ...
                >
                  <Ionicons name="person-outline" size={21} color={colors.brandWhite} />
                </Pressable>
          ...
          >
            {resuming ? (
              ...
              <>
                ...
                <Ionicons name="arrow-forward" size={24} color={colors.brandWhite} />
              </>
            )}
          </Pressable>
          ...
          {error && (
            <Pressable onPress={loadDashboard} style={styles.inlineError}>
              <Ionicons name="cloud-offline-outline" size={17} color={colors.brandRed} />
              <Text style={styles.inlineErrorText}>Certaines données n’ont pas été synchronisées. Réessayer.</Text>
            </Pressable>
          )}
        </ScrollView>
      </SafeAreaView>
