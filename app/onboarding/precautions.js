...
export default function PrecautionsScreen() {
  ...
  const setSelectedPrecautions = setPrecautions;
  ...
  function handleNext() {
    if (selectedPrecautions.length === 0) return;
    ...
    <SafeAreaView style={styles.screen}>
      ...
      >
        ...
        <View style={styles.progressArea}>
          <Text style={styles.stepText}>ÉTAPE 4 SUR 5</Text>
        ...
        <View style={styles.grid}>
          {PRECAUTIONS.map((item) => {
            const selected = selectedPrecautions.includes(item.id);
        ...
        <Pressable
          onPress={handleNext}
          disabled={selectedPrecautions.length === 0}
          style={({ pressed }) => [
